                ...
                <div className="flex gap-4 justify-center ml-[2%] md:ml-0 mt-10 flex-col md:flex-row">
                    {orders.length === 0 && (
                        <div className="bg-gray-200 flex flex-col items-center justify-center w-[95%] md:w-[50%] min-w-[315px] p-2 pt-10 pb-10 md:p-6 md:pt-10 gap-1 rounded-xl">
                            <span className="text-blue-950 font-extrabold text-3xl mb-7">Order List is empty</span>
                        </div>
                    )}
                    {orders.length > 0 && (<div className="bg-gray-200 flex flex-col items-center justify-center w-[95%] md:w-[50%] min-w-[315px] p-2 pt-10 pb-10 md:p-6 md:pt-10 gap-1 rounded-xl">
                    ...
                    <div className="bg-gray-200 flex flex-col items-center justify-center w-[100%] md:w-[40%] min-w-[320px] p-10 pb-6 gap-1 rounded-xl h-[30rem]">
                        <span className="text-blue-950 font-extrabold text-2xl md:text-3xl mb-7">Account Details</span>
